...
const resources = {
  en: {
    translation: {
      ...
      'popup.usageDisplay': 'Analyses remaining: {{remaining}}',
  ...
  de: {
    translation: {
      ...
      'popup.usageDisplay': 'Verbleibende Analysen: {{remaining}}',
  ...
  fr: { 
    translation: {
      ...
      'popup.usageDisplay': 'Analyses restantes : {{remaining}}',
  ...
  es: { 
    translation: {
      ...
      'popup.usageDisplay': 'Análisis restantes: {{remaining}}',
  ...
  it: { 
    translation: {
      ...
      'popup.usageDisplay': 'Analisi rimanenti: {{remaining}}',
  ...
  pl: { 
    translation: {
      ...
      'popup.usageDisplay': 'Pozostałe analizy: {{remaining}}',
  ...
  pt: { 
    translation: {
      ...
      'popup.usageDisplay': 'Análises restantes: {{remaining}}',
  ...
  nl: { 
    translation: {
      ...
      'popup.usageDisplay': 'Resterende analyses: {{remaining}}',
