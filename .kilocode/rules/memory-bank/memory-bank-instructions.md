...
I will then generate the core memory bank files (`product.md`, `context.md`, `architecture.md`, `tech.md`) based on my analysis. I might also improve what I find in brief.md to make it more comprehensive or complete or to remove redundancies with the other files.  These files will be stored in the `.kilocode/rules/memory-bank` folder. I will ensure these files are comprehensive and accurately reflect the project's current state. I will also create a `tasks.md` file, even if empty, to prepare for future task documentation.

I will then provide a summary of my understanding of the project, based on the newly created memory bank files. This summary will highlight key aspects of the project, such as its purpose, architecture, and technologies used. I will encourage the user to review these files and provide feedback to ensure accuracy and completeness.
